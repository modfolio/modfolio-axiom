		...
		<>
			<style>{`
				:root {
					...
					--magic-heading: "goldenbook", "sandoll-jebi2", "Noto Serif KR", serif;
					--poetic-quote: "mrs-eaves", "sandoll-jebi2", "Noto Serif KR", serif;
					--storybook-body: "adobe-caslon-pro", "sandoll-myeongjoneo1", "Noto Serif KR", serif;
						...
						{apps.map((app) => (
							<div class="card" key={app.id}>
								...
								<div class="card-footer">
									...
									<span
										class={`card-status ${app.status === "active" ? "status-active" : "status-landing"}`}
									>
										{app.status === "active"
											? "Active"
											: "준비 중"}
